...
La pantalla de Login SHALL mostrar el logo oficial de Runasimi como componente SVG (`src/components/ui/Logo.tsx`) en la parte superior del formulario.

#### Scenario: Logo visible al cargar Login
- **WHEN** el usuario navega a `/login`
- **THEN** el logo de Runasimi es visible en la parte superior del formulario
